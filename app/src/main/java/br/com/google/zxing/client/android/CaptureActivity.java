...
//
//			setContentView(R.layout.capture_flip);
//
//		}else{
//
...
//		}
		...
		ImageView id_flip_camera = (ImageView)findViewById(R.id.id_flip_camera);

		if(id_flip_camera!=null) {

			id_flip_camera.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {


					if (CustomSharedPreferences.getIntData(getApplicationContext(), CustomSharedPreferences.SP_KEY.KEY_CAMERA_FACING) == 0) {

						CustomSharedPreferences.saveIntData(getApplicationContext(), 1, CustomSharedPreferences.SP_KEY.KEY_CAMERA_FACING);

						Intent intent = new Intent("custom-event-name");
						intent.putExtra(MainActivity.KEY_CAMERA_FACING, 1);
						...
						Intent intent = new Intent("custom-event-name");
						intent.putExtra(MainActivity.KEY_CAMERA_FACING, 0);
						LocalBroadcastManager.getInstance(getApplicationContext()).sendBroadcast(intent);
	...
	protected void onResume() {
		...
		if(getIntent().getExtras().containsKey(MainActivity.KEY_CAMERA_FACING)){
			cameraManager = new CameraManager(getApplication(),getIntent().getExtras().getInt(MainActivity.KEY_CAMERA_FACING));
		}else {
			cameraManager = new CameraManager(getApplication(),getIntent().getExtras().getInt(MainActivity.KEY_CAMERA_FACING) );
		}
...
//							LocaleHelper.setLocale(CaptureActivity.this, selectedLanguage);
//						}
//						//@end
//
